...
public class CustImageTask extends AsyncTask<Object, Integer, Bitmap> {
    private final static String TAG = "CustImageTask";

    private String url, cust_acc;
...
//    }
    ...
    public CustImageTask(String url, String cust_acc, int imageSize, ImageView imageView) {
        this.url = url;
    ...
    protected Bitmap doInBackground(Object... objects) {
        ...
        jsonObject.addProperty("cust_acc", cust_acc);
    ...
    protected void onPostExecute(Bitmap bitmap) {
        ...
        if (bitmap != null) {
            ...
            imageView.setImageResource(R.drawable.ic_iconfinder_alien);
        }
    }
