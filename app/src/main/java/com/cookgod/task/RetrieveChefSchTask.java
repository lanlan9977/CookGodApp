...
public class RetrieveChefSchTask extends AsyncTask<String,String,String> {
    private final static String TAG = "OrderActivity";
    private String url,chef_ID,value;
    private List<Date> dateList;



    public RetrieveChefSchTask(String url, String chef_ID, List<Date> dateList, String value) {
        this.url = url;
        ...
        protected String doInBackground(String... strings) {
            ...
            String stringDate=gson.toJson(dateList);
