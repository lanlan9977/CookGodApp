...
public class RetrieveFoodMallDetailTask extends AsyncTask<String,String,String> {
    private final static String TAG = "RetrieveFoodMallDetailTask";
    private String url,food_id,action;


    public RetrieveFoodMallDetailTask(String URL, String food_id,String action) {
        this.url = URL;
