...
public class RetrieveOrderQRCode extends AsyncTask<String,String,String> {
    private final static String TAG = "OrderActivity";
    private String menuOrder_servlet_url, menu_od_ID,identity,identity_ID;



    public RetrieveOrderQRCode(String menuOrderServletUrl, String menu_od_ID, Boolean isChef, String identity_ID) {
        this.menuOrder_servlet_url = menuOrderServletUrl;
        ...
        protected String doInBackground(String... strings) {
            ...
            jsonObject.addProperty("action", identity);
            jsonObject.addProperty("menu_od_ID", menu_od_ID);
            jsonObject.addProperty("identity_ID", identity_ID);
