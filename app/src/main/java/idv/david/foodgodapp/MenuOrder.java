...
public class MenuOrder implements Serializable {
    ...
    public MenuOrder(String menu_od_ID, String menu_od_status, Timestamp menu_od_start, Timestamp menu_od_book, Date menu_od_end, Integer menu_od_rate, String menu_od_msg, String cust_ID, String chef_ID, String menu_ID) {
