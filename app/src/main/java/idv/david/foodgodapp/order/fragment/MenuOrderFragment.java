...
public class MenuOrderFragment extends Fragment {
    ...
    public MenuOrderFragment() {
        menuOrderList = OrderActivity.menuOrderList;
    }
    ...
    private class MenuOrderAdapter extends RecyclerView.Adapter<MenuOrderAdapter.ViewHolder> {
        ...
        public void onBindViewHolder(ViewHolder viewHolder, int position) {
            ...
            viewHolder.idMenu_or_id.setText("訂單編號："+menuOrder.getMenu_od_ID());
            viewHolder.idMenu_or_appt.setText("預約日期："+sdf.format(menuOrder.getMenu_od_book()));
            if("g0".equals(menuOrder.getMenu_od_status()))
